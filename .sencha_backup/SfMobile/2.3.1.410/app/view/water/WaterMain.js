Ext.define('SfMobile.view.water.WaterMain', {
    ...
    config: {
        ...
        tpl: Ext.create('Ext.XTemplate',
            ...
            '</tr>',
            '<tr width="100%" style="height: 2.2em;line-height:2.2em;border:1px solid #ccc;font-size:15px;text-align:center;">',
            '<td width="30%" style="border:1px solid #ccc;">库容% </td>',
            '<td width="70%" style="border:1px solid #ccc;">{[this.formatNull(values.KRpercent)]}</td>',
            '</tr>',
            '<tr width="100%" style="height: 2.2em;line-height:2.2em;border:1px solid #ccc;font-size:15px;text-align:center;">',
            '<td width="30%" style="border:1px solid #ccc;">库容</td>',
            '<td width="70%" style="border:1px solid #ccc;">{[this.formatNull(values.KR)]}</td>',
            '</tr>',
            '<tr width="100%" style="height: 2.2em;line-height:2.2em;border:1px solid #ccc;font-size:15px;text-align:center;">',
            ...
            '<tr width="100%" style="height: 2.2em;line-height:2.2em;border:1px solid #ccc;font-size:15px;text-align:center;">',
            '<td width="30%" style="border:1px solid #ccc;">危险水位</td>',
